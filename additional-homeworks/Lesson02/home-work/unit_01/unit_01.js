...
let six = document.getElementById('six').innerHTML = 'Hello world';
...
let seven = document.getElementById('seven').innerHTML = 12 * 12;


// Task 8.
// На странице создан div.out-8. С помощью document.querySelector запишите в данный элемент текст 'task-8'. 
let eight = document.querySelector('.out-8').innerHTML = 'task-8';
...
let out8 = document.querySelector('span.out-8').innerHTML = 'world';


// Task 10.
//На странице создан div.out-10. С помощью innerHTML запишите внутрь него следующую строку '<h2>Hi</h2>'.
let out10 = document.querySelector('.out-10').innerHTML = '<h2>Hi</h2>';
