...
let ar1 = ['string1', 'string 2', 2, 5, 6, true, false]
...
let ar2 = [1, 2, 'lalala', 'meow', true, 'is', false]
...
let ar3 = ['pipi', 'kokok', 1, 3, 5, true, 'seven', 'pizza', 'sushi', 'dog', 2, 6, 99]
function f3() {
...
// let ar6 =
let ar6 = ['Bluewater', 'sagittarius', '11.12.1990']
function f6() {
...
function f16() {
    ...
    document.querySelector('.out-16-even').innerHTML = ar16_even.join('_');
    document.querySelector('.out-16-odd').innerHTML = ar16_odd.join('_');
}
...
function f17() {
    ...
    for (let i of ar17){
        if (ar17[i] > 3){
            ar17_num.push(ar17[i])
        }
    }
    document.querySelector('.out-17').innerHTML = ar17_num.length;
}
...
function f18() {
    ...
    document.querySelector('.out-18').innerHTML = maxNum;
}
