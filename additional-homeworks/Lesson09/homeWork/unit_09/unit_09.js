...
function f5() {
    ...
    //console.log(out_4.getAttribute('class'));
    if (out_4.getAttribute('class') == 'out-4 bg-orange' ) {
        out.innerHTML = 'true'
    } else {
        out.innerHTML = 'false'
    }
...
function f6() {
    ...
    let paragraphs = document.querySelectorAll('p.p-6')
    out.innerHTML = paragraphs.length
}
...
function f18() {
    let out = document.querySelector('.p-18').getAttribute('data-b')
    document.querySelector('.out-18').append(out)
}
...
function f19() {
    ...
    document.querySelector('.out-19').append(out)
}
...
function f20() {
    ...
    let out = document.querySelector('.out-20').getAttributeNames();
    document.querySelector('.out-20').append(out)
}
